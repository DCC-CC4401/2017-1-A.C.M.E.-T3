...
urlpatterns = [
                  ...
                  url(r'^(?P<usuario>[a-zA-Z]+)/Perfil/$', views.viewClientFijo, name='ViewClient'),
                  url(r'^(?P<usuario>[a-zA-Z]+)/Perfil/$', views.viewClientAmb, name='ViewClient2'),
                  #url(r'^(?P<usuario>[a-zA-Z]+)/Perfil/$', views.viewClientFav, name='ViewClientFav'),
